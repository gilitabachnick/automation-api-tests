...
@test_name: test_974_LiveNG_LiveCaptionReach_TransDVRRecSESSION.py
...
6.Play the Recording entry with live caption - before(klive) and after(aws) mp4 files are uploaded.
...
class TestClass:
    ...
    def setup_class(self):
        ...
        #self.filePath = "/home/kaltura/entries/main_29_min.mp4"
        ...
        self.logi = reporter2.Reporter2('test_974_LiveNG_LiveCaptionReach_TransDVRRecSESSION')
        self.logi.initMsg('test_974_LiveNG_LiveCaptionReach_TransDVRRecSESSION')
    ...
    def test_974_LiveNG_LiveCaptionReach_TransDVRRecSESSION(self):
        global testStatus
        try: 
           ...
           # Create Admin ks
            ...
            for i in range(0, self.NumOfEntries):
                Entryobj = Entry.Entry(self.client, 'AUTOMATION-LiveEntry_LiveCaptionReach_RecSESSION_DVR_Trans' + str(i) + '_' + str(datetime.datetime.now()), "Live Automation test " + str(self.NumOfEntries) + " Entries", "Live tag", "Admintag", "Moran category", 1,None,self.CloudtranscodeId)
                self.entry = Entryobj.AddEntryLiveStream(None, None,dvrStatus=1,recordStatus=2)  # 2 : KalturaRecordStatus.PER_SESSION,  # 1 # 1 :dvrStatus enable
            ...
            for i in range(0, self.NumOfEntries):
                ...
                #####################################*********** PLAY RECORDING after stop LIVE
    ...
    def teardown_class(self):
        ...
        if testStatus == False:
           print("fail")
           self.practitest.post(self.Practi_TestSet_ID, '974','1', self.logi.msg)
           self.logi.reportTest('fail',self.sendto)        
           assert False
        else:
           print("pass")
           self.practitest.post(self.Practi_TestSet_ID, '974','0', self.logi.msg)
    ...
    #===========================================================================
    #pytest.main(['test_974_LiveNG_LiveCaptionReach_TransDVRRecSESSION.py', '-s'])
    #===========================================================================
