...
@test_name: test_978_LiveNG_LowLatencyPASS_WithoutDP_RestartAbove5min.py
...
class TestClass:
    ...
    def setup_class(self):
        ...
        self.logi = reporter2.Reporter2('test_978_LiveNG_LowLatencyPASS_WithoutDP_RestartAbove5min')
        self.logi.initMsg('test_978_LiveNG_LowLatencyPASS_WithoutDP_RestartAbove5min')
    ...
    def test_978_LiveNG_LowLatencyPASS_WithoutDP_RestartAbove5min(self):
        global testStatus
        try: 
           # create client session
            ...
            for i in range(0, self.NumOfEntries):
                Entryobj = Entry.Entry(self.client, 'AUTOMATION-LiveEntry_LowLatency_Pass_NoDP_RestartAbove5min' + str(i) + '_' + str(datetime.datetime.now()), "Live Automation test " + str(self.NumOfEntries) + " Entries", "Live tag", "Admintag", "adi category", 1,None,self.passtrhroughId)
            ...
            if deltaTime <= self.RestartDowntime:
                ...
                print("RestartTime: Wait deltaTime= " + str(deltaTime))
    ...
    def teardown_class(self):
        ...
        if testStatus == False:
           print("fail")
           self.practitest.post(self.Practi_TestSet_ID, '978','1', self.logi.msg)
           self.logi.reportTest('fail',self.sendto)        
           assert False
        else:
           print("pass")
           self.practitest.post(self.Practi_TestSet_ID, '978','0', self.logi.msg)
    ...
    #===========================================================================
    #pytest.main(['test_978_LiveNG_LowLatencyPASS_WithoutDP_RestartAbove5min.py', '-s'])
    #===========================================================================
