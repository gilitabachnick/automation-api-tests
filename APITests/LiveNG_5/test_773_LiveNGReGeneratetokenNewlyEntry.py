...
@test_name: test_773_LiveNGReGeneratetokenNewlyEntry.py
...
class TestClass:
    ...
    def setup_class(self):
        ...
        self.logi = reporter2.Reporter2('test_773_LiveNGReGeneratetokenNewlyEntry')
        self.logi.initMsg('test_773_LiveNGReGeneratetokenNewlyEntry')
    ...
    def test_773_LiveNGReGeneratetokenNewlyEntry(self):
        global testStatus
        try: 
           # create client session
            ...
            for i in range(0, self.NumOfEntries):
                ...
                if rc == False:
                    ...
                    return
                time.sleep(2)
                self.logi.appendMsg("INFO - ************** Going to ssh Start_StreamEntryByffmpegCmd with NEW TOKEN.********** ENTRY#" + str(i) + " , Datetime = " + str(datetime.datetime.now()) + " , ffmpegCmdLine_NewToken "  + ffmpegCmdLine_NewToken)
    ...
    def teardown_class(self):
        ...
        if testStatus == False:
           print("fail")
           self.practitest.post(self.Practi_TestSet_ID, '773','1', self.logi.msg)
           self.logi.reportTest('fail',self.sendto)        
           assert False
        else:
           print("pass")
           self.practitest.post(self.Practi_TestSet_ID, '773','0', self.logi.msg)
           self.logi.reportTest('pass',self.sendto)
           assert True        
    
            
    #===========================================================================
    #pytest.main('test_773_LiveNGReGeneratetokenNewlyEntry.py -s')
    #===========================================================================
