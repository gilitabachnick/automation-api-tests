...
@test_name: test_922_LiveNG_Transcoding_DVR_CFtokanization.py
...
applehttp	Live	23723 Live Tokenized CF HLS(STG) -->Access control =5750412 PROD env
...
class TestClass:
    ...
    def setup_class(self):
        ...
        self.logi = reporter2.Reporter2('test_922_LiveNG_Transcoding_DVR_CFtokanization')
        self.logi.initMsg('test_922_LiveNG_Transcoding_DVR_CFtokanization')
    ...
    def test_922_LiveNG_Transcoding_DVR_CFtokanization(self):
        global testStatus
        try:
    ...
    def teardown_class(self):
        ...
        if testStatus == False:
            print ("fail")
            self.practitest.post(self.Practi_TestSet_ID, '922', '1', self.logi.msg)
            self.logi.reportTest('fail', self.sendto)
            assert False
        else:
            print ("pass")
            self.practitest.post(self.Practi_TestSet_ID, '922', '0', self.logi.msg)
    ...
    #===========================================================================
    #pytest.main(['test_922_LiveNG_Transcoding_DVR_CFtokanization.py','-s'])
    #===========================================================================
