...
@test_name: test_0_972_LiveCaptionReachPass.py
...
class TestClass:
    ...
    def setup_class(self):
        ...
        self.logi = reporter2.Reporter2('test_0_972_LiveCaptionReachPass')
        self.logi.initMsg('test_0_972_LiveCaptionReachPass')
    ...
    def test_0_972_LiveCaptionReachPass(self):
        global testStatus
        try:
            ...
            self.logi.appendMsg("INFO - Wait for arriving to startTime = " + str(
                datetime.datetime.fromtimestamp(int(startTime)).strftime('%Y-%m-%d %H:%M:%S')))
    ...
    def teardown_class(self):
        ...
        if testStatus == False:
           print("fail")
           self.practitest.post(self.Practi_TestSet_ID, '972','1', self.logi.msg)
           self.logi.reportTest('fail',self.sendto)        
           assert False
        else:
           print("pass")
           self.practitest.post(self.Practi_TestSet_ID, '972','0', self.logi.msg)
           self.logi.reportTest('pass',self.sendto)
           assert True        
    
            
    #===========================================================================
    #pytest.main('test_0_972_LiveCaptionReachPass.py -s')
    #===========================================================================
