...
@test_name: test_926_LiveNG_SRT_SrtPassEncrpyted_InvalidInfo.py
 ...
 Update SrtPass and then stream with No info about Encrpyted and passphrase -- > Verify the the primary+ backup are streaming ok.
"srt://srtlb.cluster-1-a.live.nvq1.ovp.kaltura.com:7045/kLive?streamid=#:::e=0_tihujbqw,st=0,p=10fc19dd" - stream plays
...
class TestClass:
    ...
    def setup_class(self):
        ...
        self.logi = reporter2.Reporter2('test_924_LiveNG_SRT_SrtPassEncrpyted_NoInfo')
        self.logi.initMsg('test_924_LiveNG_SRT_SrtPassEncrpyted_NoInfo')

    def test_924_LiveNG_SRT_SrtPassEncrpyted_NoInfo(self):
        global testStatus
        try: 
           # create client session
            ...
            for i in range(0, self.NumOfEntries):
                Entryobj = Entry.Entry(self.client, 'AUTOMATION-SPRIMARYBACKUP_SRTPassEncrpytedValidInfo_' + str(i) + '_' + str(datetime.datetime.now()), "Live Automation test " + str(self.NumOfEntries) + " Entries", "Live tag", "Admintag", "adi category", 1,None,self.passtrhroughId)
    ...
    def teardown_class(self):
        ...
        if testStatus == False:
           print("fail")
           self.practitest.post(self.Practi_TestSet_ID, '924','1', self.logi.msg)
           self.logi.reportTest('fail',self.sendto)        
           assert False
        else:
           print("pass")
           self.practitest.post(self.Practi_TestSet_ID, '924','0', self.logi.msg)
