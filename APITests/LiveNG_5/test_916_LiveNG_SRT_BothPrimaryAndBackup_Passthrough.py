...
@test_name: test_916_LiveNG_SRT_BothPrimaryAndBackup_Passthrough.py
...
class TestClass:
    ...
    def setup_class(self):
        ...
        self.logi = reporter2.Reporter2('test_916_LiveNG_SRT_BothPrimaryAndBackup_Passthrough')
        self.logi.initMsg('test_916_LiveNG_SRT_BothPrimaryAndBackup_Passthrough')

    def test_916_LiveNG_SRT_BothPrimaryAndBackup_Passthrough(self):
        global testStatus
        try: 
    ...
    def teardown_class(self):
        ...
        if testStatus == False:
           print("fail")
           self.practitest.post(self.Practi_TestSet_ID, '916','1', self.logi.msg)
           self.logi.reportTest('fail',self.sendto)        
           assert False
        else:
           print("pass")
           self.practitest.post(self.Practi_TestSet_ID, '916','0', self.logi.msg)
           self.logi.reportTest('pass',self.sendto)
           assert True        
    
            
    #===========================================================================
    #pytest.main('test_916_LiveNG_SRT_BothPrimaryAndBackup_Passthrough.py -s')
    #===========================================================================
