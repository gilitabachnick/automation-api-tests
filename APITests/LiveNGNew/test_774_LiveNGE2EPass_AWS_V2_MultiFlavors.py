...
@test_name: test_774_LiveNGE2EPass_AWS_V2_MultiFlavors.py
 
 @desc : This test check E2E test of new LiveNG entries Passthrough by creating New Player v2 
...
class TestClass:
    ...
    def setup_class(self):
        ...
        self.source_file1="/home/kaltura/entries/LongCloDvRec.mp4"
        self.source_file2="/home/kaltura/entries/LongCloDvRec.mp4"
        self.source_file3="/home/kaltura/entries/LongCloDvRec.mp4"     
        ...
        self.logi = reporter2.Reporter2('test_774_LiveNGE2EPass_AWS_V2_MultiFlavors')
        self.logi.initMsg('test_774_LiveNGE2EPass_AWS_V2_MultiFlavors')
    ...
    def test_774_LiveNGE2EPassthrough_AWS_V2Player(self):
        global testStatus
        try: 
           # create client session
            ...
            for i in range(0, self.NumOfEntries):
                ...
                if rc == False:
                    self.logi.appendMsg("FAIL - Start_StreamEntryByffmpegCmd. Start_StreamEntryByffmpegCmd details: " + self.remote_host + " , " + self.remote_user + " , " + self.remote_pass + " , " + self.filePath + " ," + self.entryId + " , " + self.PublisherID + " , " + str(self.playerId) + " , ffmpegCmdLine = " + str(ffmpegCmdLine))
                    testStatus = False
                    return
    ...
    def teardown_class(self):
        ...
        if testStatus == False:
           print("fail")
           self.practitest.post(self.Practi_TestSet_ID, '774','1', self.logi.msg)
           self.logi.reportTest('fail',self.sendto)        
           assert False
        else:
           print("pass")
           self.practitest.post(self.Practi_TestSet_ID, '774','0', self.logi.msg)
           self.logi.reportTest('pass',self.sendto)
           assert True        
    
            
    #===========================================================================
    #pytest.main('test_774_LiveNGE2EPass_AWS_V2_MultiFlavors.py -s')
    #===========================================================================
