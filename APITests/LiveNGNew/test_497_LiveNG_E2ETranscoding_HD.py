...
@test_name: test_497_LiveNG_E2ETranscoding_HD.py
 
 @desc : This test check E2E test of new LiveNG entries cloud transcording HD by creating New Player v2 + v3
...
class TestClass:
    ...
    def setup_class(self):
        ...
        #self.SRT = ast.literal_eval(inifile.RetIniVal(section, 'SRT'))
        if self.IsSRT == True:
            self.sniffer_filter_per_flavor_list = '-s43;-s43;-s32;-s33'  # ts search for each flavor on flavorList - Delivery profile 1033:Live packager hls -redirect
        else:
            self.sniffer_filter_per_flavor_list = '-s43;-s43;-s35;-s33'  #ts search for each flavor on flavorList - Delivery profile 1033:Live packager hls -redirect
        ...
        self.logi = reporter2.Reporter2('test_497_LiveNG_E2ETranscoding_HD')
        self.logi.initMsg('test_497_LiveNG_E2ETranscoding_HD')
    ...
    def test_497_LiveNG_E2ETranscoding_HD(self):
        global testStatus
        try: 
           # create client session
            ...
            for i in range(0, self.NumOfEntries):
                Entryobj = Entry.Entry(self.client, 'AUTOMATION-TRANSCODING_HD_SWITCHFLAVORS' + str(i) + '_' + str(datetime.datetime.now()), "Live Automation test " + str(self.NumOfEntries) + " Entries", "Live tag", "Admintag", "Moran category", 1,None,self.CloudtranscodeId)
    ...
    def teardown_class(self):
        ...
        if testStatus == False:
           print("fail")
           self.practitest.post(self.Practi_TestSet_ID, '497','1', self.logi.msg)
           self.logi.reportTest('fail',self.sendto)        
           assert False
        else:
           print("pass")
           self.practitest.post(self.Practi_TestSet_ID, '497','0', self.logi.msg)
           self.logi.reportTest('pass',self.sendto)
           assert True        
    
            
    #===========================================================================
    #pytest.main('test_497_LiveNG_E2ETranscoding_HD.py -s')
    #===========================================================================
