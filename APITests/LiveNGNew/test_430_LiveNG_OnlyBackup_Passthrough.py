...
@test_name: test_430_LiveNG_OnlyBackup_Passthough.py
 
 @desc : This test check E2E test of new LiveNG entries streaming only backup + Passthough by creating New Player v2 + v3 
...
class TestClass:
    ...
    def setup_class(self):
        ...
        self.logi = reporter2.Reporter2('test_430_LiveNG_OnlyBackup_Passthrough ')
        self.logi.initMsg('test_430_LiveNG_OnlyBackup_Passthrough ')
    ...
    def test_430_LiveNG_OnlyBackup_Passthrough(self):
        global testStatus
        try: 
    ...
    def teardown_class(self):
        ...
        if testStatus == False:
           print("fail")
           self.practitest.post(self.Practi_TestSet_ID, '430','1', self.logi.msg)
           self.logi.reportTest('fail',self.sendto)        
           assert False
        else:
           print("pass")
           self.practitest.post(self.Practi_TestSet_ID, '430','0', self.logi.msg)
           self.logi.reportTest('pass',self.sendto)
           assert True        
    
            
    #===========================================================================
    #pytest.main('test_430_LiveNG_OnlyBackup_Passthrough.py -s')
    #===========================================================================
