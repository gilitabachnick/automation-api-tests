...
@test_name: test_779_LiveNGE2EPassthrough_gop.py
 
 @desc : This test check E2E test of new LiveNG entries Passthrough by creating New Player v3
 Start RTMP streaming by new logic function with gop + bitrate cmd in ffmpeg host access run ffmpeg cmd.
...
class TestClass:
    ...
    def setup_class(self):
        ...
        self.logi = reporter2.Reporter2('test_779_LiveNGE2EPassthrough_gop')
        self.logi.initMsg('test_779_LiveNGE2EPassthrough_gop')
    ...
    def test_779_LiveNGE2EPassthrough_gop(self):
        global testStatus
        try: 
           # create client session
            ...
            for i in range(0, self.NumOfEntries):
                ...
                ffmpegCmdLine=self.liveObj.ffmpegCmdString_gop(self.filePath, str(Current_primaryBroadcastingUrl), self.streamUrl[i].streamName,IsSRT=self.IsSRT)
    ...
    def teardown_class(self):
        ...
        if testStatus == False:
           print("fail")
           self.practitest.post(self.Practi_TestSet_ID, '779','1', self.logi.msg)
           self.logi.reportTest('fail',self.sendto)        
           assert False
        else:
           print("pass")
           self.practitest.post(self.Practi_TestSet_ID, '779','0', self.logi.msg)
           self.logi.reportTest('pass',self.sendto)
           assert True        
    
            
    #===========================================================================
    #pytest.main('test_779_LiveNGE2EPassthrough_gop.py -s')
    #===========================================================================
