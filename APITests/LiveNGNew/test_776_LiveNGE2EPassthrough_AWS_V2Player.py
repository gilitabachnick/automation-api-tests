...
@test_name: test_776_LiveNGE2EPassthrough_AWS_V2Player.py
...
class TestClass:
    ...
    def setup_class(self):
        ...
        self.logi = reporter2.Reporter2('test_776_LiveNGE2EPassthrough_AWS_V2Player')
        self.logi.initMsg('test_776_LiveNGE2EPassthrough_AWS_V2Player')
    ...
    def test_776_LiveNGE2EPassthrough_AWS_V2Player(self):
        global testStatus
        try:
    ...
    def teardown_class(self):
        ...
        if testStatus == False:
           print("fail")
           self.practitest.post(self.Practi_TestSet_ID, '776','1', self.logi.msg)
           self.logi.reportTest('fail',self.sendto)        
           assert False
        else:
           print("pass")
           self.practitest.post(self.Practi_TestSet_ID, '776','0', self.logi.msg)
           self.logi.reportTest('pass',self.sendto)
           assert True        
    
            
    #===========================================================================
    #pytest.main('test_776_LiveNGE2EPassthrough_AWS_V2Player.py -s')
    #===========================================================================
