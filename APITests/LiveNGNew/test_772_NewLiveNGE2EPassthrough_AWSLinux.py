...
@test_name: test_772_NewLiveNGE2EPassthrough_AWSLinux.py
...
class TestClass:
    ...
    def setup_class(self):
        ...
        self.logi = reporter2.Reporter2('test_772_NewLiveNGE2EPassthrough_AWSLinux')
        self.logi.initMsg('test_772_NewLiveNGE2EPassthrough_AWSLinux')
    ...
    def test_772_NewLiveNGE2EPassthrough_AWSLinux(self):
        global testStatus
        try: 
    ...
    def teardown_class(self):
        ...
        if testStatus == False:
           print("fail")
           self.practitest.post(self.Practi_TestSet_ID, '772','1', self.logi.msg)
           self.logi.reportTest('fail',self.sendto)        
           assert False
        else:
           print("pass")
           self.practitest.post(self.Practi_TestSet_ID, '772','0', self.logi.msg)
           self.logi.reportTest('pass',self.sendto)
           assert True        
    
            
    #===========================================================================
    #pytest.main('test_772_NewLiveNGE2EPassthrough_AWSLinux.py -s')
    #===========================================================================
