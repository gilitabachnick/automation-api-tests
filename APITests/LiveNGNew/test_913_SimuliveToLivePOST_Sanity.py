...
@test_name: test_913_SimuliveToLivePOST_Sanity.py
  @desc : this test check E2E test of  test_913_SimuliveToLivePOST_Sanity - Create simulive event by kaltura API and then play the entry on LIVE logic platform
...
class TestClass:
    ...
    def setup_class(self):
        ...
        self.MainEntryId = self.inifile.RetIniVal('Simulive_Partner_' + self.PublisherID,'SimuliveToLivePOST_MainEntryId_Ron2min')  # QA "0_1vlw5w0o" #PROD "1_njw9gegj"#2 min duration - File LongCloDvRec_Post_2min.mp4
        self.preStartEntryId = self.inifile.RetIniVal('Simulive_Partner_' + self.PublisherID,'SimuliveToLivePOST_preStartEntryId_Ron1min')  # QA "0_tvf86gsi" #PROD "1_reogx2ap" # 1 minutes duration - File LongCloDvRec_Pre_1min.mp4
        self.postEndEntryId = self.inifile.RetIniVal('Simulive_Partner_' + self.PublisherID, 'SimuliveToLivePOST_postEndEntryId_Dual10min')  # QA "0_m8f9f3cy"  #PROD"1_mbm0aeve" #10 min duration - File AUTOMATIONmainForDual_10min.mp4
    ...
    def teardown_class(self):
        ...
        if testStatus == False:
           print("fail")
           self.practitest.post(self.Practi_TestSet_ID, '913','1', self.logi.msg)
           self.logi.reportTest('fail',self.sendto)        
           assert False
        else:
           print("pass")
           self.practitest.post(self.Practi_TestSet_ID, '913','0', self.logi.msg)
           self.logi.reportTest('pass',self.sendto)
           assert True        
    
            
    #===========================================================================
    #pytest.main('test_913_SimuliveToLivePOST_Sanity.py -s')
    #===========================================================================
