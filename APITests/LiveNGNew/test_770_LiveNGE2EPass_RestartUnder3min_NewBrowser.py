...
@test_name: test_770_LiveNGE2EPass_RestartUnder3min_NewBrowser.py
...
class TestClass:
    ...
    def setup_class(self):
        ...
        self.logi = reporter2.Reporter2('test_770_LiveNGE2EPass_RestartUnder3min_NewBrowser')
        self.logi.initMsg('test_770_LiveNGE2EPass_RestartUnder3min_NewBrowser')
    ...
    def test_770_LiveNGE2EPass_RestartUnder3min_NewBrowser(self):
        global testStatus
        try: 
    ...
    def teardown_class(self):
        ...
        if testStatus == False:
           print("fail")
           self.practitest.post(self.Practi_TestSet_ID, '770','1', self.logi.msg)
           self.logi.reportTest('fail',self.sendto)        
           assert False
        else:
           print("pass")
           self.practitest.post(self.Practi_TestSet_ID, '770','0', self.logi.msg)
    ...
    #===========================================================================
    #pytest.main(['test_770_LiveNGE2EPass_RestartUnder3min_NewBrowser.py', '-s'])
    #===========================================================================
