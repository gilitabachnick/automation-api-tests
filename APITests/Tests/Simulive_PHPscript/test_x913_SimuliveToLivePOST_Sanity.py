...
@test_name: test_x913_SimuliveToLivePOST_Sanity.py
  @desc : this test check E2E test of  test_913_SimuliveToLivePOST_Sanity - Create simulive event by ASSAF PHP script and then play the entry on LIVE logic platform
...
class TestClass:
    ...
    def setup_class(self):
        ...
        if isProd:
            ...
            self.MainEntryId = "1_qa9xteqo" #2 min duration # $argv[11]; // $config[$env]['vodId'];
            ...
            self.MainEntryId = "0_l81xhd9y"#2 min duration
        ...
        self.sleepUntilCloseBrowser=240#(seconds) for waiting to close the browser after playback verification
        self.MinToPlay_BeforeStartStreaming=4
        ...
        self.SchedulerEvent_sessionEndOffset = 13  # Total Duration of the SchedulerEvent_sessionEndOffset playback = preEntryId.duration + mainEntry.duration + postEntry.duration
        self.reduceMinutesFromStartTime = 8
        self.preStartEntryId_duration = 1  # preEntryid.Duration  1 minute
        self.SchedulerEvent_MainEntryId_duration = 2  # 3 minutes duration of self.MainEntryId
        self.SchedulerEvent_TotalSimulivePlaybackDuration=13#Total Duration of the SchedulerEvent_sessionEndOffset playback = preEntryId.duration + mainEntry.duration + postEntry.duration
        ...
        self.logi = reporter2.Reporter2('test_913_SimuliveToLivePOST_Sanity')
        self.logi.initMsg('test_913_SimuliveToLivePOST_Sanity')
    
    def test_913_SimuliveToLivePOST_Sanity(self):
        global testStatus
        try: 
           # create client session
            ...
            sessionTitle='AUTOMATION-SimuliveToLive_POST' + str(datetime.datetime.now())
            ...
            que = queue.Queue()
            #x = threading.Thread(target=lambda q, arg1, arg2, arg3, arg4, arg5: q.put(self.liveObj.verifyAllEntriesPlayOrNoBbyOnlyPlayback(arg1, arg2, arg3, arg4, arg5)), args=(que, self.entrieslst, True, self.SchedulerEvent_sessionEndOffset - self.reduceMinutesFromStartTime - 2,self.PlayerVersion,self.sniffer_fitler_SimuliveVOD))  # reduce -16 mintes for the total 30-->TO 14 playback
            #x = threading.Thread(target=lambda q, arg1, arg2, arg3, arg4, arg5: q.put(self.liveObj.verifyAllEntriesPlayOrNoBbyOnlyPlayback(arg1, arg2, arg3, arg4, arg5)), args=(que, self.entrieslst, True,1,self.PlayerVersion,self.sniffer_fitler_SimuliveVOD))  # reduce -16 mintes for the total 30-->TO 14 playback
            ...
            time.sleep(60*(self.MinToPlay_BeforeStartStreaming+1))  # Wait for the thread to start playing the entry - 4 minutes
    ...
    def teardown_class(self):
        ...
        if testStatus == False:
           print("fail")
           self.practitest.post(Practi_TestSet_ID, '913','1', self.logi.msg)
           self.logi.reportTest('fail',self.sendto)        
           assert False
        else:
           print("pass")
           self.practitest.post(Practi_TestSet_ID, '913','0', self.logi.msg)
           self.logi.reportTest('pass',self.sendto)
           assert True        
    
            
    #===========================================================================
    #pytest.main('test_x913_SimuliveToLivePOST_Sanity.py -s')
    #===========================================================================
