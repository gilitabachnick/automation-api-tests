...
@test_name: test_x912_SimuliveToLivePRE_Sanity.py
  @desc : this test check E2E test of  test_912_SimuliveToLivePRE_Sanity - Create simulive event by ASSAF PHP script and then play the entry on LIVE logic platform
...
class TestClass:
    ...
    def setup_class(self):
        ...
        if isProd:
            ...
            #########SIMULIVE CONFIG
            self.conversionProfileID = "17469513"
            self.kwebcastProfileId = "16890803"
            self.eventsProfileId = "16890813"

            self.MainEntryId = "1_njw9gegj"
            self.preStartEntryId = "1_reogx2ap"
            self.postEndEntryId = "1_mbm0aeve"
            ...
            self.MainEntryId = "0_1vlw5w0o"#10 min duration
            self.preStartEntryId ="0_tvf86gsi" #10 min duration
            ...
            #self.PlayerV7_confVars = '{"versions":{"kaltura-ovp-player":"{latest}", "playkit-kaltura-live":"{canary}"},"langs":["en"]}'
            self.PlayerV7_confVars = inifile.RetIniVal(section, 'PlayerV7_confVars')#'{"versions":{"kaltura-ovp-player":"{latest}", "playkit-kaltura-live":"2.2.5"},"langs":["en"]}'
    ...
    def test_912_SimuliveToLivePRE_Sanity(self):
        ...
        try: 
           # create client session
            ...
            que = queue.Queue()
            x = threading.Thread(target=lambda q, arg1, arg2, arg3, arg4, arg5, arg6: q.put(self.liveObj.verifyAllEntriesPlayOrNoBbyOnlyPlayback(arg1, arg2, arg3, arg4, arg5, arg6)), args=(que, self.entrieslst, True,1,self.PlayerVersion,self.sniffer_fitler_SimuliveVOD,self.sleepUntilCloseBrowser))  # reduce -16 mintes for the total 30-->TO 14 playback
    ...
    def teardown_class(self):
        ...
        if testStatus == False:
           print("fail")
           self.practitest.post(Practi_TestSet_ID, '912','1', self.logi.msg)
           self.logi.reportTest('fail',self.sendto)        
           assert False
        else:
           print("pass")
           self.practitest.post(Practi_TestSet_ID, '912','0', self.logi.msg)
           self.logi.reportTest('pass',self.sendto)
           assert True        
    
            
    #===========================================================================
    #pytest.main('test_x912_SimuliveToLivePRE_Sanity.py -s')
    #===========================================================================
