...
@test_name: test_Simulive_preStartEntryId_postEndEntryId_RedirectScheduleEvent.py
  @desc : this test check E2E test of  test_837_Simulive_CreateScheduleEvent - Create simulive event by ASSAF PHP script and then play the entry on LIVE logic platform
