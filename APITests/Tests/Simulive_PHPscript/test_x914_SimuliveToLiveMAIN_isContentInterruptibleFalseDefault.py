...
@test_name: test_x914_SimuliveToLiveMAIN_isContentInterruptibleFalseDefault.py
  @desc : this test check E2E test of  test_914_SimuliveToLiveMAIN_isContentInterruptibleFalseDefault - Create simulive event by ASSAF PHP script and then play the entry on LIVE logic platform
 ...
 * Precondition to upload those 3 files to QA env and PROD env
 ...
 3)Verify that just after arriving to POST area -> The live entry content is played on the simulive entry.
...
class TestClass:
    ...
    def setup_class(self):
        ...
        if isProd:
            ...
            self.MainEntryId = "1_n6mie47o"#5 min duration # $argv[11]; // $config[$env]['vodId'];
            self.preStartEntryId = "1_b2x73t0y"# 1 minutes duration
            self.postEndEntryId = "1_mbm0aeve"#10 min duration
            self.sniffer_fitler_SimuliveVOD = '/hlsm/'#'qa-aws-vod'
            self.sniffer_fitler_SimuliveToLIVE ='/hls/'#/hls/;s32.ts'#'klive-stg;-s32.ts'
            ...
            self.MainEntryId = "0_m5aia7c7"#5 min duration
            self.preStartEntryId ="0_nwuqpww7" # 1 minutes duration
            self.postEndEntryId = "0_m8f9f3cy"#10 min duration
    ...
    def teardown_class(self):
        ...
        if testStatus == False:
           print("fail")
           self.practitest.post(Practi_TestSet_ID, '914','1', self.logi.msg)
           self.logi.reportTest('fail',self.sendto)        
           assert False
        else:
           print("pass")
           self.practitest.post(Practi_TestSet_ID, '914','0', self.logi.msg)
           self.logi.reportTest('pass',self.sendto)
           assert True        
    
            
    #===========================================================================
    #pytest.main('test_x914_SimuliveToLiveMAIN_isContentInterruptibleFalseDefault.py -s')
    #===========================================================================
