...
request_1 = sendRequest('https://connectors.nvq1.ovp.kaltura.com/api/v1', "/data-sync", "/syncReport")
...
body_1 = body({
  ...
  "updatedAtGreaterThanOrEqual": "2019-08-24T14:15:22Z",
  "updatedAtLessThanOrEqual": "2019-08-24T14:15:22Z"
}
)
