...
class TestClass:
    ...
    def test_891_Passthrough_PackagerRestart_kubernetesThreads(self):
        ...
        try:
            ...
            for i in range(0, self.NumOfEntries):
                ...
                rc = self.KubernetesObj.Kubernetes_RestartComponent(self.Kubernetes_remote_host,self.Kubernetes_remote_user,self.Kubernetes_remote_pass,entryId=self.entryId,partnerId=self.PublisherID,env=self.env,BroadcastingUrl=Current_primaryBroadcastingUrl,currentComponent=currentPackager)
                if rc == True:
    ...
    def teardown_class(self):
        ...
        if testStatus == False:
           print("fail")
           self.practitest.post(Practi_TestSet_ID, '891','1')
           self.logi.reportTest('fail',self.sendto)
           assert False
        else:
           print("pass")
           self.practitest.post(Practi_TestSet_ID, '891','0')
