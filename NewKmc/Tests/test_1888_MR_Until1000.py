...
@author: Moran.Cohen
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
@test_name: test_1888_MR_Until1000
 
 @desc : This test check mediaRepurposing dry run table log on case of until 1000 items  
...
class TestClass:
    ...
    def setup_class(self):
        try:       
            ...
            if isProd:
                ...
                self.MediaRepurposingID = "4101" #< 1000
            else:
                section = "Testing"
                self.env = 'testing'
                ...
                self.MediaRepurposingID = "1241" #< 1000
            ...
            self.logi = reporter2.Reporter2('test_1888_MR_Until1000')
    ...
    def test_1888_MR_Above1000(self):
        
        global testStatus
        self.logi.initMsg('test_1888_MR_Until1000')       
        ...
        try:
            ...
            rc = self.MediaRepurposingFuncs.MediaRepurposing_DryRunIdentificationResultUntil1000(ActualbatchJobId)
            if not rc:
    ...
    def teardown_class(self):
        ...
        if testStatus == False:
            self.practitest.post(Practi_TestSet_ID, '1888','1')
            self.logi.reportTest('fail',self.sendto)
            assert False
        else:
            self.practitest.post(Practi_TestSet_ID, '1888','0')
    ...
    #===========================================================================
    # pytest.main(args=['test_1888_MR_Until1000.py','-s'])
    # pytest.main('test_1888_MR_Until1000.py -s')    
    #===========================================================================
