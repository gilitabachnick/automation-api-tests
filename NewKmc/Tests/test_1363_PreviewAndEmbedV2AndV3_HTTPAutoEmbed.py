...
@author: Moran.Cohen
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
@test_name: test_1363_PreviewAndEmbedV2_HTTPAutoEmbed
 
 @desc : this test uploading video entry and playing it with HTTP & Auto Embed player 
...
class TestClass:
    ...
    def setup_class(self):
        ...
        try:
            ...
            self.logi = reporter2.Reporter2('test_1363_PreviewAndEmbedV2AndV3_HTTPAutoEmbed')
    ...
    def test_1363_PreviewAndEmbedV2_HTTPDynamicEmbed(self):
        
        global testStatus
        
        
        PreviewEmbedTYPESelectionText = "Auto Embed"
        PreviewEmbedHTTPSSelection = False    
        

        self.logi.initMsg('test_1363_PreviewAndEmbedV2AndV3_HTTPAutoEmbed.py')
    ...
    def teardown_class(self):
        ...
        if testStatus == False:
            self.practitest.post(Practi_TestSet_ID, '1363', '1')
            self.logi.reportTest('fail',self.sendto)
            assert False
        else:
            self.practitest.post(Practi_TestSet_ID, '1363', '0')
    ...
    #===========================================================================
    # pytest.main('test_1363_PreviewAndEmbedV2AndV3_HTTPAutoEmbed.py -s')    
    #===========================================================================
