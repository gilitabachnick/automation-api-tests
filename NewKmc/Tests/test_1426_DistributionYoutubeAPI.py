...
@test_name: test_1426_DistributionYoutubeAPI
 
 @desc : The test performs youtube API distribution 
    ...
    #===========================================================================
     def setup_class(self):
        ...
        try:
            ...
            self.DistributionProfileSelectionText    = inifile.RetIniVal(section, 'DistributionProfileSelectionYoutubeAPI')
            self.DistributionEntryName  = 'out'
            self.DistributionfilePth    = r'\out.mp4' 
            self.BasicFuncs = KmcBasicFuncs.basicFuncs()
            self.practitest = Practitest.practitest('4586')
            self.logi = reporter2.Reporter2('test_1426_DistributionYoutubeAPI')
     ...
     def test_1426_DistributionYoutubeAPI(self):
             
        global testStatus
        
        self.logi.initMsg('test_1426_DistributionYoutubeAPI')
        ...
        try:            
            ...
            rc = self.entryPage.EntrySetBasicMetadata(self.DistributionEntryName,"DescriptionYouTubeAPI","TagsYoutubeAPI",None,None)
            if rc:
     ...
     def teardown(self):
        ...
        if testStatus == False:
            ...
            self.practitest.post(Practi_TestSet_ID, '1426','1')
            assert False
        else:
            self.logi.reportTest('pass',"moran.cohen@kaltura.com")
            self.practitest.post(Practi_TestSet_ID, '1426','0')
            assert True         
            
            
     #==========================================================================
     # pytest.main('test_1426_DistributionYoutubeAPI.py -s')
     #==========================================================================