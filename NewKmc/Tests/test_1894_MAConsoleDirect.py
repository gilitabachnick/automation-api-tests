...
@test_name: test_1894_MAConsoleDirect.py
...
class TestClass:
    ...
    def setup_class(self):
        ...
        try:
            ...
            self.logi = reporter2.Reporter2('test_1894_MAConsoleDirect')
    ...
    def test_1894_MAConsoleDirect(self):
             
        global testStatus

        try:
            self.logi.initMsg('test_1894_MAConsoleDirect')
    ...
    def teardown_class(self):
        ...
        try:
            if testStatus == False:
                self.practitest.post(Practi_TestSet_ID, '1894','1')
                self.logi.reportTest('fail',self.sendto)
                assert False
            else:
                self.practitest.post(Practi_TestSet_ID, '1894','0')
    ...
    #===========================================================================
    # pytest.main(args=['test_1894_MAConsoleDirect.py','-s'])
    # pytest.main('test_1894_MAConsoleDirect.py -s')    
    #===========================================================================
