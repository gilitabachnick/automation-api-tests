...
@test_name: test_1423_DistributionMediaPCUSTOM
 
 @desc : The test performs mediaPrep custom distribution 
    ...
    #===========================================================================
     def setup_class(self):
        ...
        try:
            ...
            self.logi = reporter2.Reporter2('test_1423_DistributionMediaPCUSTOM')
     ...
     def test_1423_DistributionMediaPCUSTOM(self):
             
        global testStatus
        
        self.logi.initMsg('test_1423_DistributionMediaPCUSTOM')
        ...
        try:            
            ...
            rc = self.entryPage.EntrySetBasicMetadata(self.DistributionEntryName,None,None,None,"entryRef_mediaPrepCustom")
            if rc:
     ...
     def teardown(self):
        ...
        if testStatus == False:
            ...
            self.practitest.post(Practi_TestSet_ID, '1423','1')
            assert False
        else:
            self.logi.reportTest('pass',"moran.cohen@kaltura.com")
            self.practitest.post(Practi_TestSet_ID, '1423','0')
            assert True         
            
            
     #==========================================================================
     # pytest.main('test_1423_DistributionMediaPCUSTOM.py -s')
     #==========================================================================