...
@author: Moran.Cohen
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
@test_name: test_1362_PreviewAndEmbedV2_HTTPDynamicEmbed

 @desc : this test uploading video entry and playing it with HTTP & Dynamic Embed player 
...
class TestClass:
    ...
    def setup_class(self):
        ...
        try:
            ...
            self.logi = reporter2.Reporter2('test_1362_PreviewAndEmbedV2AndV3_HTTPDynamicEmbed')
    ...
    def test_1362_PreviewAndEmbedV2_HTTPDynamicEmbed(self):
        ...
        self.logi.initMsg('test_1362_PreviewAndEmbedV2AndV3_HTTPDynamicEmbed.py')
    ...
    def teardown_class(self):
        ...
        if testStatus == False:
            self.practitest.post(Practi_TestSet_ID, '1362','1')
            self.logi.reportTest('fail',self.sendto)
            assert False
        else:
            self.practitest.post(Practi_TestSet_ID, '1362','0')
    ...
    #===========================================================================
    #pytest.main('test_1362_PreviewAndEmbedV2AndV3_HTTPDynamicEmbed.py -s')
    #===========================================================================
