...
class TestClass:
    ...
    def test_1308(self):
        ...
        sessionId, boolRunOnlyFailed = self.practitest.getPractiTestAutomationSession(envfieldId=135921, runonlyfail=136639)
        print("-------2---------")

        try:
            self.practitest.setTestSetAutomationStatusAsProcessed(Practi_TestSet_ID, jobName="leaderboard")
